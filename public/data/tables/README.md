...
As of 2024, most table data is generated by AI queries using mostly Clausd-3-Opus ("Opus"). Useful chat responses are in [tables/README_AI_CHAT.md](https://github.com/t2civ/astropolis_sdk/blob/master/public/data/tables/README_AI_CHATS.md). Commentary and verification links are sometimes included. 
...
* With some exceptions: all fuels combustion is used to generate electricity, and all energy input for operations is in the form of electricity. This will mostly be the case for a space economy. We'll have mechanics to handle exceptions, e.g., a space smelter that uses focused sunlight.
