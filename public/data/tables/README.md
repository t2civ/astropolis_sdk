...
As of 2024, most table data is generated by AI queries. Useful chat responses are in [tables/README_AI_CHAT.md](https://github.com/t2civ/astropolis_sdk/blob/master/public/data/tables/README_AI_CHATS.md). Some validation links are provided here. 
