...
- markets — Markets where this Facility expects to buy or sell resources. Each value is a Market name of the form `MARKET_<body_name>`. An Market exists for each Body that has more than one Facility.
