...
4. For setting `carrying_capacity` for farms and similar, consider the number of people (and their families) typically involved in these activities on Earth, where 1 module provides 1 unit of the respective operation(s).
