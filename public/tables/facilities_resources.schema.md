...
- surplus — Excess inventory available for sale. Usually 0 if facility is net consumer and >0 if net producer.
...
2. The two values sum to total present inventory: `stock` = `reserve` + `surplus`.
