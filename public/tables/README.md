...
As of 2024, most table data is generated by AI queries. Useful chat responses are in [tables/README_AI_CHAT.md](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md). Some validation links are provided here. 
...
* 'flops' is the same as FLOPS but standardized to single-precision float (e.g., 4.0 EFLOPS at quarter-precision would be 1.0 Eflops in our sim).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Moon-Geology).
...
From [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Anthropogenic-Mass) on anthropogenic mass we have 1.1e12 tonnes in 2020, doubling every 20 years. That puts us at 5.5e11 in 2000 and 7.8e11 in 2010. We split the 2010 values by:
* USA 20% -> 1.6e11 t
* Russia 5% -> 3.9e10 t
* China 30% -> 2.3e11 t
* Europe 15% -> 1.2e11 t
...
We have ISS at 420 tonnes and Tiangong at 22 tonnes from [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#ISS--Tiangong). We just slice up the ISS among NASA, Roscosmos, ESA and JAXA:
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Biomass--Bioproductivity). Table values are double the AI values to convert C to dry weight.
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Renewable-Power-Generation).
...
Using 2010 fossil fuels values from [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Non-Renewable-Power-Generation).

See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Uranium-Fuel--Power) for uranium fission power.

#### ISS & Tiangong

See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#ISS--Tiangong).
...
We use 2010 regional and depth production values for oil and gas from [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Oil--Gas-Production).

2010 coal production values from [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Coal-Mining). Note that most of the "underground mining" in that chat is surface (0-1 km) in our sim. I'm using ~15% subsurface for USA, Russia, and EU and much smaller percents for others.
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Population).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Uranium-Fuel--Power).

Low-enriched uranium for typical civilian nuclear power.

#### OPERATION_OIL_xxxx_DRILLING

See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Oil--Gas-Energy-Input).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Coal-Mining).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Uranium-Mining).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Industrial-Metals-Mining).
...
Using mostly 2010 prices from [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Resource-Prices).
...
See [AI Chat](https://github.com/t2civ/astropolis_sdk/blob/master/public/tables/README_AI_CHATS.md#Precious-Metals--Rare-Earths-Mining).
...
#### RESOURCE_STEEL_STRUCTURES, _ALUMINIUM_STRUCTURES, _COMPOSITE_STRUCTURES

There are three kinds to provide some resource fungibility. Steel is cheap but heavy (so not great for launching from Earth). Aluminum is light and moderately priced. Composite is very light and very expensive.

#### RESOURCE_HEAVY_MACHINERY

Factory machines, big metal parts, etc. Production counts toward the 'Manufacturing' development stat.

#### RESOURCE_ROBOTICS

From factory robots to androids (minus the brains). Production counts toward the 'Manufacturing' development stat.

#### RESOURCE_ELECTRICAL_SYSTEMS

Catchall for power systems, wiring, and non-IC electronics. Production counts toward the 'Manufacturing' development stat.
...
Measured in processor-unit-hours (puhr). CPU Time is generated by CPU Clusters and used for all sorts of different service industries. For example, a legal firm might buy CPU Time and convert it into Legal Services.
